...
async def send_dm_to_role(guild,role,send_message,embed=None,important=False,member_blacklist=None):
    i=0
    sended_to=list()
    for member in guild.members:
        if member_blacklist is not None and member in member_blacklist: continue
